...
$userDirectory = $_GET['user'];

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'data/upload/userfiles/'.$userDirectory,
    'root'         => $_SERVER['DOCUMENT_ROOT'].'/data/upload/userfiles/'.$userDirectory, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,

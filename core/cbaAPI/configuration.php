...
// possible values:
// 0 = do not check/verify hostnameas
...
// $configArray["merchantId"] = "TESTUBOPTYEVAL01";

// API username in the format below where Merchant ID is the same as above
// $configArray["apiUsername"] = "merchant.TESTUBOPTYEVAL01";

// API password which can be configured in Merchant Administration
// $configArray["password"] = "26fa612b25853237fc7ade1d32ce3e58";
...
class Merchant {
	...
	private $gatewayUrl = "https://paymentgateway.commbank.com.au/api/rest";
	private $merchantId = "UBONUSCOM201";
	private $apiUsername = "merchant.UBONUSCOM201";
	private $password = "8fff1593282be71ed87d3d9199a696d6";
	private $debug = false;
	private $version = "45";

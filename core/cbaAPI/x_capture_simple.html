...
<html>
    ...
    <body>
        ...
        <h3>Simple Capture Operation</h3>
        ...
        <table width="60%" align="center" cellpadding="5" border="0">
            ...
            <tr>
                ...
                <td><input type="text" name="orderId" value="" size="20" maxlength="60"/><br/>
                    <span style="font-size:8pt">ID of the existing Order to capture against</span></td>
            </tr>
            ...
            <tr class="shade">
                ...
                <td width="50%"><input type="text" readonly="readonly" name="apiOperation" value="CAPTURE" size="20" maxlength="80"/></td>
            </tr>

            <tr>
                <td align="right"><strong>transaction.amount </strong></td>
                <td><input type="text" name="transaction[amount]" value="" size="8" maxlength="13"/></td>
            </tr>

            <tr class="shade">
                <td align="right"><strong>transaction.currency </strong></td>
                <td><input type="text" name="transaction[currency]" value="" size="8" maxlength="3"/></td>
            </tr>

            <tr>
                <td colspan="2"><center><input type="submit" name="submit" value="Process Capture"/></center></td>
            </tr>

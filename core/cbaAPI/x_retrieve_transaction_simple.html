...
<html>
  ...
  <body>
      ...
      <h3>Simple Retrieve Transaction Operation</h3>
    ...
    <table width="60%" align="center" cellpadding="5" border="0">
      ...
      <!-- Credit Card Fields -->
        ...
        <tr>
            ...
            <td width="50%"><input type="text" readonly="readonly" name="method" value="GET" size="20" maxlength="80"/> ** See Note 1 Below</td>
        </tr>


        <tr class="shade">
             <td align="right" width="50%"><strong>apiOperation </strong></td>
             <td width="50%"><input type="text" readonly="readonly" name="apiOperation" value="RETRIEVE_TRANSACTION" size="20" maxlength="80"/></td>
         </tr>

         <tr>
              <td colspan="2"><center><input type="submit" name="submit" value="Process Retrieval"/></center></td>
         </tr>

...
<html>
  ...
  <body>
      ...
      <h3>Simple Update Authorization Operation</h3>
    ...
    <table width="60%" align="center" cellpadding="5" border="0">
        ...
        <tr class="shade">
            ...
            <td><input type="text" name="orderId" value="" size="20" maxlength="60"/><br/>
                <span style="font-size:8pt">Order ID of the existing Authorization transaction you wish to update.</span></td>
        </tr>
        ...
        <tr>
         ...
         <tr>
             ...
             <td width="50%"><input type="text" readonly="readonly" name="apiOperation" value="UPDATE_AUTHORIZATION" size="20" maxlength="20"/></td>
         </tr>
         ...
         <tr>
              <td colspan="2"><center><input type="submit" name="submit" value="Process Update Authorisation"/></center></td>
         </tr>

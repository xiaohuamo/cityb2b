        ...
        <table width="60%" align="center" cellpadding="5" border="0">
            ...
            <tr>
                ...
                <td><input type="text" name="orderId" value="" size="20" maxlength="60"/><br/>
                    <span style="font-size:8pt">ID of the existing Order to void against</span></td>
            </tr>
            ...
            <tr class="shade">
                ...
                <td><input type="text" name="transactionId" value="" size="20" maxlength="60"/><br/>
                    <span style="font-size:8pt">ID of the void transaction that will be created</span></td>
            </tr>
            ...
            <tr><td colspan="2"></td></tr>
             ...
             <tr class="shade">
                 ...
                 <td width="50%"><input type="text" readonly="readonly" name="apiOperation" value="VOID" size="20" maxlength="80"/></td>
             </tr>

             <tr>
                 <td align="right" width="50%"><strong>transaction.targetTransactionId </strong></td>
                 <td><input type="text" name="transaction[targetTransactionId]" value="" size="20" maxlength="60"/><br/>
                    <span style="font-size:8pt">ID of the existing transaction to void</span></td>
             </tr>

             <tr>
                 <td colspan="2"><center><input type="submit" name="submit" value="Process Void"/></center></td>
             </tr>

...
<html>
  ...
  <body>
      ...
      <h3>Simple Initiate Browser Payment Operation</h3>
    ...
    <table width="60%" align="center" cellpadding="5" border="0">
        ...
        <tr class="shade">
             ...
             <td width="50%"><input type="text" readonly="readonly" name="apiOperation" value="INITIATE_BROWSER_PAYMENT" size="40" maxlength="80"/></td>
         </tr>

         <tr>
             <td align="right"><strong>sourceOfFunds.type </strong></td>
             <td><input type="text" name="sourceOfFunds[type]" value="" size="10" maxlength="80"/></td>
         </tr>
         ...
         <tr>
              <td colspan="2"><center><input type="submit" name="submit" value="Process Initiate"/></center></td>
         </tr>

...
class mdl_factory2c_list extends mdl_base
{
   ...
   public static  function getAvaliableDateOfAllSalesChannelOfThisFactory($businessId) {
	   ...
	   public static  function getSqlofAllOrdersDataOfCurrentBusiness($businessId,$tableName,$factroy_id,$totalandeverychannelPrint) {
		...
		//var_dump($totalandeverychannelPrint);exit;
		  if($businessId) {
			$sql =" SELECT r.source_menu_id,c.restaurant_menu_id ,r.menu_id,c.guige_des,r.menu_cn_name,r.menu_en_name,if(length(r.unit_en)>0,r.unit_en,r.unit) as unit ,c.order_id,u.googleMap,u.displayName,o.address,concat(o.first_name,' ',o.last_name) as customerName ,o.logistic_sequence_No,o.logistic_truck_No,c.bonus_title,c.customer_buying_quantity,r.unit  from ";

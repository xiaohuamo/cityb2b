...
class mdl_wj_user_temp_carts extends mdl_base
{
	...
	function getDetailedItemOfBusiness($userId,$businessUserId){
        $sql="select w.*,a.*,b.pic,b.bonusType,b.sales_user_list,b.pickup_avaliable,b.deliver_avaliable,b.perCustomerLimitQuantity,b.EvoucherOrrealproduct from #@_wj_user_temp_carts a LEFT JOIN #@_coupons as b  on  b.id =a.main_coupon_id LEFT JOIN #@_wholesale AS w ON w.couponid=a.main_coupon_id where businessUserId ='". $businessUserId ."' and  userId =".$userId . " order by a.main_coupon_id ,a.sub_coupon_id  ";

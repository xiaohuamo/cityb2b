<?php 
class ctl_voucher_subscription extends cmsPage
{
	...
	{	
    	...
    	*/
        $this->display_pc_mobile('voucher_subscription/voucher_subscription-pc','voucher_subscription/voucher_subscription-mobile');

...
class MyApi
{
    ...
    public function createContacts($credentials, $json = "") // array of Contact in json
    {
        ...
        */        
        ...
        $arr = [
            [
                "ContactNumber" => "56789", // your system db customer id
                "Name" => "Customer Four", // company or customer name
                "FirstName" => "Customer",
                "Lastname" => "Four",
    ...
    public function getContacts($credentials)
    {
        ...
        */
        ...
        /*********************************** GET CONTACTS *****************/
        $arr = [
            //"modified_since" => "2023-01-01", // last modified
            //"where" => 'ContactStatus == "ARCHIVED"', // ACTIVE, ARCHIVED, GDPRREQUEST
    ...
    public function getItems($credentials)
    {
        ...
        /*********************************** GET SINGLE ITEM ***************************************/
        /*
        $itemID = "a1ed7f9f-61ab-4044-a567-ba0031da94f4";
        ...
        */
        ...
        $arr = [
            //"modified_since" => "2023-01-01", // last modified
            //"where" => 'ItemID=="a1ed7f9f-61ab-4044-a567-ba0031da94f4"', // forbidden
            "where" => 'Code=="P-1003"', // works
            //"where" => "IsSold==true",
    ...
    public function getInvoices($credentials)
    {
        ...
        $arr = [
            //"modified_since" => "2023-01-01", // last modified
            //"where" => 'Status == "VOIDED"', // DRAFT, SUBMITTED, AUTHORISED, DELETED, VOIDED
            //"order_by" => "Name ASC", // order by
            "ids" => [ // array or InvoiceID
                "1a5ba4a0-260e-4eca-8ddf-84c751da13b8",
            ],
            //'invoice_numbers' => [
